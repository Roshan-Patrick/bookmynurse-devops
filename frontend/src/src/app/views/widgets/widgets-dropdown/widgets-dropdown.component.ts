...
export class WidgetsDropdownComponent implements OnInit, AfterContentInit {
  ...
  constructor(
    private changeDetectorRef: ChangeDetectorRef, private nurseService: NurseRegService
  ) { }
  ...
  getAllRegistered() {
    this.nurseService.nurseRegistered().subscribe((res: any) => {
      this.nurseRegister = res.data.length
    })
  }

    getAllClientRegistered() {
    this.nurseService.getAllRegistered('Ongoing').subscribe((res: any) => {
      console.log(res)
      this.client = res.data.length;
    })
  }
